            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="name" name="name" type="text" value="{{ $role->name }}" class="mt-1 p-2 border rounded-md w-full" required autofocus autocomplete="name">
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        @foreach ($permissions as $permission)
                            ...
                            <div class="flex items-center">
                                <input class="mr-2" type="checkbox" value="{{ $permission->id }}" id="{{ $permission->id }}" name="permissions[]" {{$rolExist}}>
