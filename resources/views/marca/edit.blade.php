<<x-app-layout>
    <x-slot name="header">
        <h1 class="text-2xl font-semibold">Editar Marca</h1>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('marca.update', $marca) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nombre" class="form-input rounded-md shadow-sm w-full" value="{{ $marca->nombre }}">
                    </div>
                    <div class="mb-4">
                        <label for="direccion" class="block text-gray-700 text-sm font-bold mb-2">Descripcion:</label>
                        <input type="text" name="descripcion" class="form-input rounded-md shadow-sm w-full" value="{{ $marca->descripcion }}">
                    </div>
